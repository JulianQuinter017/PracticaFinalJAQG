...
router.get('/index',(req,res)=>{
	...
	res.render('index.ejs',{titulo:'Index'})
});
router.get('/acercade',(req,res)=>{

	res.render('acercade.ejs',{titulo:'Acerca de'})
});

router.get('/contactos',(req,res) => {

	res.render('contactos.ejs', { titulo : 'Agenda de Contactos', contactos: [], contacto: null })
});

router.post('/contactos', async (req,res) => {

	let contactos = await dbContactos.Contactos.mostrarTodos();
	if (!contactos.length) return res.render('contactos.ejs', { titulo : 'Agenda de Contactos', contactos: [], contacto: null });
	res.render('contactos.ejs', { titulo : 'Agenda de Contactos', contactos: contactos, contacto: null })
});
